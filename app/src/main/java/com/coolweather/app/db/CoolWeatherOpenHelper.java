...
/**
 * Created by LiJun on 2017/11/10.
 */
...
public class CoolWeatherOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_COUNTY="create table County(id integer primary key autoincrement,counyt_name text, county_code text,city_id integer)";
